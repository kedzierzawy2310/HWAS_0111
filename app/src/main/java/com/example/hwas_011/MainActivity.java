    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        if (resultCode==RESULT_OK){
            if(requestCode==BUTTON_REQUEST1)
            {
                ...
                przypisz[current_contact]=current_sound;
            }
            else if(requestCode==BUTTON_REQUEST2)
            {
                ImageView im =(ImageView) findViewById(R.id.contact_image);
                Random r =new Random();
                Integer[] images={R.drawable.ante, R.drawable.james, R.drawable.kyrie, R.drawable.rose, R.drawable.walker, R.drawable.wall};
                ...
                current_sound=przypisz[current_contact];
            }
